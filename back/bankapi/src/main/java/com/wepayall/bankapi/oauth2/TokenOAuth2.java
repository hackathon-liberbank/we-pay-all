...
import com.wepayall.bankapi.generated.model.AccessTokenResponse;
...
public class TokenOAuth2 {
    ...
    public String getAccessTokenFromLiberbankForAccount(String code) {
        return getToken(code, getHeadersAccounts());
    }

    public String getAccessTokenFromLiberbankForAccountBalances(String code) {
        return getToken(code, getHeadersBalances());
    }

    public String getAccessTokenFromLiberbankForAccountTransactions(String code) {
        return getToken(code, getHeadersTransactions());
    }

    public String getAccessTokenFromLiberbankForPayments(String code) {
        return getToken(code, getHeadersToken());
    }

    private String getToken(String code, HttpHeaders headers) {
    ...
    private HttpHeaders getHeadersToken() {
